...
<body>
  ...
  <?php
    ...
    <form action="<?=$_SERVER['PHP_SELF']?>" method="post"  class="form-control">
       <fieldset><legend>Modifier des données d'un Appartement</legend> Réference:<input type="text" name="ref" value="<?=$value[0]?>"><br>
        ...
        Surface de l'espace commun<input type="text" name ="surcom" value="<?=$value[8]?>"><br>
