...
<body>
    <div class="container">
    <form action="../../controller/appartement/insert.php" method="post"  class="form-control">
       <fieldset><legend>Ajout d'un Appartement</legend> Réference:<input type="text" name="ref" ><br>
        ...
        Surface de l'espace commun<input type="text" name ="surcom"><br>
